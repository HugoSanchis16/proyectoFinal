...
public class JocDeLaVida extends JFrame implements ActionListener {
	...
	private static final int tamaño_TABLERO_MEDIANO = 50;
	private static final int tamaño_TABLERO_GRANDE = 60;
	...
	private Color[] arrayColores = { new Color(255, 0, 0), new Color(168, 0, 204), new Color(255, 103, 35),
			new Color(255, 103, 35), new Color(63, 0, 231), new Color(168, 0, 0), new Color(0, 137, 0),
			new Color(88, 0, 134), new Color(221, 0, 160) };
	...
	public JocDeLaVida() throws HeadlessException {
	...
	private void aleatorizarCeldas() {
		...
		int maximoContadorCeldas = (tablero.length * tablero[0].length) / 14; // Establecer un máximo del 5% de celdas
																				// vivas
...
//
		...
		for (int i = 0; i < tablero.length; i++) {
			for (int j = 0; j < tablero[0].length; j++) {
				...
				if (tablero[i][j]) {
					// llevar 2 primeres linies i descomentar lo de dalt
